...
class UltrafastSecp256k1 {
  ...
  void _bindAll() {
    _version = _lib.lookupFunction<_VersionC, _VersionDart>('ultrafast_secp256k1_version');
    _init = _lib.lookupFunction<_InitC, _InitDart>('ultrafast_secp256k1_init');
    _pubkeyCreate = _lib.lookupFunction<_PubkeyCreateC, _PubkeyCreateDart>('ultrafast_secp256k1_ec_pubkey_create');
    _pubkeyCreateUncompressed = _lib.lookupFunction<_PubkeyCreateC, _PubkeyCreateDart>('ultrafast_secp256k1_ec_pubkey_create_uncompressed');
    _pubkeyParse = _lib.lookupFunction<_PubkeyParseC, _PubkeyParseDart>('ultrafast_secp256k1_ec_pubkey_parse');
    _seckeyVerify = _lib.lookupFunction<_SeckeyVerifyC, _SeckeyVerifyDart>('ultrafast_secp256k1_ec_seckey_verify');
    _privNegate = _lib.lookupFunction<_PrivNegateC, _PrivNegateDart>('ultrafast_secp256k1_ec_privkey_negate');
    _privTweakAdd = _lib.lookupFunction<_PrivTweakC, _PrivTweakDart>('ultrafast_secp256k1_ec_privkey_tweak_add');
    _privTweakMul = _lib.lookupFunction<_PrivTweakC, _PrivTweakDart>('ultrafast_secp256k1_ec_privkey_tweak_mul');
    _ecdsaSign = _lib.lookupFunction<_EcdsaSignC, _EcdsaSignDart>('ultrafast_secp256k1_ecdsa_sign');
    _ecdsaVerify = _lib.lookupFunction<_EcdsaVerifyC, _EcdsaVerifyDart>('ultrafast_secp256k1_ecdsa_verify');
    _serializeDer = _lib.lookupFunction<_SerializeDerC, _SerializeDerDart>('ultrafast_secp256k1_ecdsa_signature_serialize_der');
    _signRecoverable = _lib.lookupFunction<_SignRecoverableC, _SignRecoverableDart>('ultrafast_secp256k1_ecdsa_sign_recoverable');
    _recover = _lib.lookupFunction<_RecoverC, _RecoverDart>('ultrafast_secp256k1_ecdsa_recover');
    _schnorrSign = _lib.lookupFunction<_SchnorrSignC, _SchnorrSignDart>('ultrafast_secp256k1_schnorr_sign');
    _schnorrVerify = _lib.lookupFunction<_SchnorrVerifyC, _SchnorrVerifyDart>('ultrafast_secp256k1_schnorr_verify');
    _schnorrPubkey = _lib.lookupFunction<_SchnorrPubkeyC, _SchnorrPubkeyDart>('ultrafast_secp256k1_schnorr_pubkey');
    _ecdh = _lib.lookupFunction<_EcdhC, _EcdhDart>('ultrafast_secp256k1_ecdh');
    _ecdhXonly = _lib.lookupFunction<_EcdhC, _EcdhDart>('ultrafast_secp256k1_ecdh_xonly');
    _ecdhRaw = _lib.lookupFunction<_EcdhC, _EcdhDart>('ultrafast_secp256k1_ecdh_raw');
    _sha256 = _lib.lookupFunction<_Sha256C, _Sha256Dart>('ultrafast_secp256k1_sha256');
    _hash160 = _lib.lookupFunction<_Hash160C, _Hash160Dart>('ultrafast_secp256k1_hash160');
    _taggedHash = _lib.lookupFunction<_TaggedHashC, _TaggedHashDart>('ultrafast_secp256k1_tagged_hash');
    _addressP2pkh = _lib.lookupFunction<_AddressC, _AddressDart>('ultrafast_secp256k1_address_p2pkh');
    _addressP2wpkh = _lib.lookupFunction<_AddressC, _AddressDart>('ultrafast_secp256k1_address_p2wpkh');
    _addressP2tr = _lib.lookupFunction<_AddressC, _AddressDart>('ultrafast_secp256k1_address_p2tr');
    _wifEncode = _lib.lookupFunction<_WifEncodeC, _WifEncodeDart>('ultrafast_secp256k1_wif_encode');
    _wifDecode = _lib.lookupFunction<_WifDecodeC, _WifDecodeDart>('ultrafast_secp256k1_wif_decode');
    _bip32Master = _lib.lookupFunction<_Bip32MasterC, _Bip32MasterDart>('ultrafast_secp256k1_bip32_master_key');
    _bip32DeriveChild = _lib.lookupFunction<_Bip32DeriveChildC, _Bip32DeriveChildDart>('ultrafast_secp256k1_bip32_derive_child');
    _bip32DerivePath = _lib.lookupFunction<_Bip32DerivePathC, _Bip32DerivePathDart>('ultrafast_secp256k1_bip32_derive_path');
    _bip32GetPrivkey = _lib.lookupFunction<_Bip32GetKeyC, _Bip32GetKeyDart>('ultrafast_secp256k1_bip32_get_privkey');
    _bip32GetPubkey = _lib.lookupFunction<_Bip32GetKeyC, _Bip32GetKeyDart>('ultrafast_secp256k1_bip32_get_pubkey');
    _taprootOutputKey = _lib.lookupFunction<_TaprootOutputKeyC, _TaprootOutputKeyDart>('ultrafast_secp256k1_taproot_output_key');
    _taprootTweakPriv = _lib.lookupFunction<_TaprootTweakPrivC, _TaprootTweakPrivDart>('ultrafast_secp256k1_taproot_tweak_privkey');
    _taprootVerify = _lib.lookupFunction<_TaprootVerifyC, _TaprootVerifyDart>('ultrafast_secp256k1_taproot_verify_commitment');
  }
