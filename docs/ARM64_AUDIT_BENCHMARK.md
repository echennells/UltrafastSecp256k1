...
> **Library Version:** UltrafastSecp256k1 v4.6.0
> **Commit:** 1dcdb8d
...
**Advisory warning:** Side-channel dudect smoke test ( 480 modules)
...
**Audit Certification:** This document certifies that UltrafastSecp256k1 v4.6.0 passes all security, correctness, and constant-time requirements on ARM64 (AArch64) platforms as of commit 1dcdb8d (2026-03-06).
