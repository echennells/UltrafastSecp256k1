...
| Audit modules | 479 across 9 failure classes |
...
**Verdict**: **CAAS Self-Audit Verdict: AUDIT-READY (self-generated continuous audit; no external third-party security audit has been completed)** -- 479 modules, 9 failure classes
...
|----------------------|---------------------------------------------|
| Audit Sections       | 8                                           |
| Audit Modules        | 203 (non-exploit modules) |
...
*Generated from unified_audit_runner v4.6.0 output + CI workflow analysis. Last updated 2026-04-01.*
