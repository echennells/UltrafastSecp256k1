...
| **Audit runner** | `unified_audit_runner` (204 non-exploit + 276 exploit PoCs = 480 modules) | `gpu_audit_runner` ( 480 modules) | `opencl_audit_runner` ( 480 modules) | `metal_audit_runner` ( 480 modules) |
