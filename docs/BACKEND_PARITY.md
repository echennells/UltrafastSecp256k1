...
| **Audit runner** | `unified_audit_runner` (202 non-exploit + 276 exploit PoCs = 478 modules) | `gpu_audit_runner` ( 478 modules) | `opencl_audit_runner` ( 478 modules) | `metal_audit_runner` ( 478 modules) |
