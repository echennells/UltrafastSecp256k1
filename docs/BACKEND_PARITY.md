...
**Last updated**: 2026-04-21 | **Version**: 4.6.0
...
| **Audit runner** | `unified_audit_runner` (203 non-exploit + 276 exploit PoCs = 479 modules) | `gpu_audit_runner` ( 479 modules) | `opencl_audit_runner` ( 479 modules) | `metal_audit_runner` ( 479 modules) |
