...
| **Audit runner** | `unified_audit_runner` (201 non-exploit + 276 exploit PoCs = 477 modules) | `gpu_audit_runner` ( 477 modules) | `opencl_audit_runner` ( 477 modules) | `metal_audit_runner` ( 477 modules) |
